...
binder::Status NetdNativeService::networkAddRoute(int32_t, const std::string&, const std::string&,
                                                  const std::string&) {
    DEPRECATED;
}

binder::Status NetdNativeService::networkRemoveRoute(int32_t, const std::string&,
